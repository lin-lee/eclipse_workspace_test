...
//http://wallimn.iteye.com/blog/2059128
/**
 * * <b>function:</b>实现MongoDB的CRUD操作 * @author hoojo * @createDate 2011-6-2
 * 下午03:21:23 * @file MongoDB4CRUDTest.java * @package com.hoo.test * @project
 * MongoDB * @blog http://blog.csdn.net/IBM_hoojo * @email hoojo_@126.com * @version
 * 1.0
 */
public class MongoDB4CRUDTest {
	...
	public void init() {
		try {
			...
			e.printStackTrace();
		} // 获取temp DB；如果默认没有创建，mongodb会自动创建 db = mg.getDB("temp");
	...
	/**
	 * * <b>function:</b> 查询所有数据 * @author hoojo * @createDate 2011-6-2
	 * 下午03:22:40
	 */
	...
	public void query() {
		...
		print("findAndModify: "
				+ users.findAndModify(new BasicDBObject("age", 28),
				// 查询age=28的数据
						new BasicDBObject("name", true),
						// 查询name属性
