...
public class ASMClassModifyAdpter extends ClassAdapter {
	...
	public MethodVisitor visitMethod(final int access, final String methodName,
		...
		if("display1".equals(methodName)) {
			...
			methodVisitor.visitFieldInsn(Opcodes.PUTFIELD , "com/lin/java/chapter3/AsmTest/ForASMTestClass" , "name" , "Ljava/lang/String;");
			
			//这条语句等价于增加代码：value = "我是value";
			methodVisitor.visitVarInsn(Opcodes.ALOAD , 0);
			methodVisitor.visitLdcInsn("我是value");
			methodVisitor.visitFieldInsn(Opcodes.PUTFIELD , "com/lin/java/chapter3/AsmTest/ForASMTestClass" , "value" , "Ljava/lang/String;");
			
			//再将一个属性获取出来打印出来
			methodVisitor.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out" , "Ljava/io/PrintStream;");
			methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
			methodVisitor.visitFieldInsn(Opcodes.GETFIELD, "com/lin/java/chapter3/AsmTest/ForASMTestClass", "name", "Ljava/lang/String;");
