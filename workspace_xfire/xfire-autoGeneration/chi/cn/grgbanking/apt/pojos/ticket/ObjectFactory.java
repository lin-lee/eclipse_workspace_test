...
package cn.grgbanking.apt.pojos.ticket;
...
public class ObjectFactory {
    ...
    private final static QName _EspecialTicketIsAeraTicket_QNAME = new QName("http://ticket.pojos.apt.grgbanking.cn", "isAeraTicket");
    private final static QName _EspecialTicketQuantity_QNAME = new QName("http://ticket.pojos.apt.grgbanking.cn", "quantity");
    private final static QName _EspecialTicketTkName_QNAME = new QName("http://ticket.pojos.apt.grgbanking.cn", "tkName");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ticket.pojos.apt.grgbanking.cn", name = "isAeraTicket", scope = EspecialTicket.class)
    public JAXBElement<Integer> createEspecialTicketIsAeraTicket(Integer value) {
        return new JAXBElement<Integer>(_EspecialTicketIsAeraTicket_QNAME, Integer.class, EspecialTicket.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ticket.pojos.apt.grgbanking.cn", name = "tkName", scope = EspecialTicket.class)
    public JAXBElement<String> createEspecialTicketTkName(String value) {
        return new JAXBElement<String>(_EspecialTicketTkName_QNAME, String.class, EspecialTicket.class, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Serializable }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ticket.pojos.apt.grgbanking.cn", name = "id", scope = EspecialTicket.class)
    public JAXBElement<Serializable> createEspecialTicketId(Serializable value) {
        return new JAXBElement<Serializable>(_EspecialTicketId_QNAME, Serializable.class, EspecialTicket.class, value);
    }
