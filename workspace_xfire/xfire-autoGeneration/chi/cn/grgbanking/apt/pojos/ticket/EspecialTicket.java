 ...
 *         &lt;element name="id" type="{http://io.java}Serializable" minOccurs="0"/>
 *         &lt;element name="isAeraTicket" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
public class EspecialTicket {
    ...
    protected JAXBElement<Serializable> id;
    @XmlElementRef(name = "isAeraTicket", namespace = "http://ticket.pojos.apt.grgbanking.cn", type = JAXBElement.class)
    protected JAXBElement<Integer> isAeraTicket;
    ...
    @XmlElementRef(name = "tkName", namespace = "http://ticket.pojos.apt.grgbanking.cn", type = JAXBElement.class)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Serializable }{@code >}
     *     
     */
    public JAXBElement<Serializable> getId() {
        return id;
    }
     ...
     *     
     */
    public void setId(JAXBElement<Serializable> value) {
        this.id = ((JAXBElement<Serializable> ) value);
    }

    /**
     * Gets the value of the isAeraTicket property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Integer> getIsAeraTicket() {
        return isAeraTicket;
    }

    /**
     * Sets the value of the isAeraTicket property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setIsAeraTicket(JAXBElement<Integer> value) {
        this.isAeraTicket = ((JAXBElement<Integer> ) value);
    }
    ...
    public void setTkName(JAXBElement<String> value) {
        this.tkName = ((JAXBElement<String> ) value);
    }
