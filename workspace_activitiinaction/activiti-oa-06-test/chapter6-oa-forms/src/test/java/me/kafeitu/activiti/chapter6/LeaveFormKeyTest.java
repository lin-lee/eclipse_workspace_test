...
public class LeaveFormKeyTest extends AbstractTest{
	private static final Logger log = LoggerFactory.getLogger(LeaveFormKeyTest.class);
	...
	public void allPass() {
		...
		ProcessDefinition processDefinition = repositoryService
						.createProcessDefinitionQuery().processDefinitionKey("leave-formkey").singleResult();
		//读取启动表单
		Object renderedStartForm = formService
								.getRenderedStartForm(processDefinition.getId());
