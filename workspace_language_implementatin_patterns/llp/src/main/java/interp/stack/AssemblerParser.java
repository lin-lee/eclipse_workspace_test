...
// $ANTLR 3.5.2 Assembler.g 2017-01-01 14:16:57
...
public class AssemblerParser extends Parser {
		...
		try {
			...
			switch (alt4) {
				...
				case 3 :
					...
					match(input,15,FOLLOW_15_in_instr242); 
				...
				case 4 :
					...
					match(input,15,FOLLOW_15_in_instr266); 
					pushFollow(FOLLOW_operand_in_instr270);
					b=operand();
					state._fsp--;

					match(input,15,FOLLOW_15_in_instr272); 
	...
	public final void label() throws RecognitionException {
		...
		try {
			...
			match(input,18,FOLLOW_18_in_label398); 
			defineLabel(ID7);
			}
	...
	public static final BitSet FOLLOW_16_in_functionDeclaration109 = new BitSet(new long[]{0x0000000000000080L});
	public static final BitSet FOLLOW_ID_in_functionDeclaration113 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_18_in_functionDeclaration115 = new BitSet(new long[]{0x0000000000100000L});
	public static final BitSet FOLLOW_20_in_functionDeclaration117 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_functionDeclaration119 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_INT_in_functionDeclaration123 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_functionDeclaration125 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_21_in_functionDeclaration127 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_19_in_functionDeclaration129 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_INT_in_functionDeclaration133 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_NEWLINE_in_functionDeclaration135 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_instr166 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_NEWLINE_in_instr168 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_instr204 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr206 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_NEWLINE_in_instr208 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_instr236 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr240 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_instr242 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr246 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_NEWLINE_in_instr248 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_instr260 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr264 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_instr266 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr270 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_instr272 = new BitSet(new long[]{0x00000000000019F0L});
	public static final BitSet FOLLOW_operand_in_instr276 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_NEWLINE_in_instr278 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_label396 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_18_in_label398 = new BitSet(new long[]{0x0000000000000002L});
}
