...
// $ANTLR 3.5.2 Def.g 2016-12-27 11:36:56
...
public class Def extends TreeFilter {
	...
	// $ANTLR start "topdown"
	// Def.g:19:1: topdown : ( enterBlock | enterMethod | enterClass | varDeclaration | atoms );
	public final void topdown() throws RecognitionException {
		try {
			// Def.g:20:5: ( enterBlock | enterMethod | enterClass | varDeclaration | atoms )
			int alt1=5;
			switch ( input.LA(1) ) {
			case BLOCK:
				{
	...
	// Def.g:27:1: bottomup : ( exitBlock | exitMethod | exitClass );
	public final void bottomup() throws RecognitionException {
		try {
			// Def.g:28:5: ( exitBlock | exitMethod | exitClass )
			int alt2=3;
			switch ( input.LA(1) ) {
			case BLOCK:
				{
	...
	// Def.g:47:1: enterClass : ^( 'class' name= ID ( ^( EXTENDS sup= ID ) )? . ) ;
	public final void enterClass() throws RecognitionException {
		CymbolAST name=null;
		CymbolAST sup=null;

		try {
			// Def.g:48:5: ( ^( 'class' name= ID ( ^( EXTENDS sup= ID ) )? . ) )
			// Def.g:48:9: ^( 'class' name= ID ( ^( EXTENDS sup= ID ) )? . )
			{
			match(input,27,FOLLOW_27_in_enterClass208); if (state.failed) return;
			match(input, Token.DOWN, null); if (state.failed) return;
			name=(CymbolAST)match(input,ID,FOLLOW_ID_in_enterClass212); if (state.failed) return;
			// Def.g:48:27: ( ^( EXTENDS sup= ID ) )?
			int alt3=2;
	...
	// Def.g:63:1: exitClass : 'class' ;
	public final void exitClass() throws RecognitionException {
		try {
			// Def.g:64:5: ( 'class' )
			// Def.g:64:9: 'class'
			{
			match(input,27,FOLLOW_27_in_exitClass256); if (state.failed) return;
			if ( state.backtracking==1 ) {
	...
	// Def.g:71:1: enterMethod : ^( METHOD_DECL type= . ID ( . )* ) ;
	public final void enterMethod() throws RecognitionException {
		CymbolAST ID1=null;
		CymbolAST type=null;

		try {
			// Def.g:72:5: ( ^( METHOD_DECL type= . ID ( . )* ) )
			// Def.g:72:9: ^( METHOD_DECL type= . ID ( . )* )
			{
	...
	// Def.g:83:1: exitMethod : METHOD_DECL ;
	public final void exitMethod() throws RecognitionException {
		try {
			// Def.g:84:5: ( METHOD_DECL )
			// Def.g:84:9: METHOD_DECL
			{
	...
	public final void atoms() throws RecognitionException {
		...
		try {
			...
			if ( input.LA(1)==ID||input.LA(1)==33 ) {
				input.consume();
	...
	// Def.g:101:1: varDeclaration : ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type= . ID ( . )? ) ;
	public final void varDeclaration() throws RecognitionException {
		CymbolAST ID2=null;
		CymbolAST type=null;

		try {
			// Def.g:102:5: ( ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type= . ID ( . )? ) )
			// Def.g:102:9: ^( ( FIELD_DECL | VAR_DECL | ARG_DECL ) type= . ID ( . )? )
			{
	...
	public static final BitSet FOLLOW_27_in_enterClass208 = new BitSet(new long[]{0x0000000000000004L});
	...
	public static final BitSet FOLLOW_27_in_exitClass256 = new BitSet(new long[]{0x0000000000000002L});
