...
// $ANTLR 3.5.2 Types.g 2016-12-29 09:09:45
...
public class Types extends TreeFilter {
	...
	public final void ifstat() throws RecognitionException {
		...
		try {
			...
			{
			match(input,52,FOLLOW_52_in_ifstat106); if (state.failed) return;
	...
	public final Types.ret_return ret() throws RecognitionException {
		...
		try {
			...
			{
			match(input,54,FOLLOW_54_in_ret177); if (state.failed) return retval;
	...
	// $ANTLR start "expr"
	// Types.g:48:1: expr returns [Type type] : ( 'true' | 'false' | CHAR | INT | FLOAT | ID | ^( UNARY_MINUS a= expr ) | ^( UNARY_NOT a= expr ) | ^( ADDR a= expr ) | ^( DEREF a= expr ) | member | call | binaryOps );
	public final Types.expr_return expr() throws RecognitionException {
		...
		try {
			// Types.g:50:5: ( 'true' | 'false' | CHAR | INT | FLOAT | ID | ^( UNARY_MINUS a= expr ) | ^( UNARY_NOT a= expr ) | ^( ADDR a= expr ) | ^( DEREF a= expr ) | member | call | binaryOps )
			int alt4=13;
			switch ( input.LA(1) ) {
			case 55:
				{
			...
			switch (alt4) {
				case 1 :
					// Types.g:50:9: 'true'
					{
					match(input,55,FOLLOW_55_in_expr269); if (state.failed) return retval;
				...
				case 2 :
					// Types.g:51:9: 'false'
					{
					match(input,50,FOLLOW_50_in_expr286); if (state.failed) return retval;
					if ( state.backtracking==1 ) {retval.type = SymbolTable._boolean;}
					}
					break;
				case 3 :
				...
				case 9 :
					...
					if ( state.backtracking==1 ) {retval.type =new PointerType((a!=null?((Types.expr_return)a).type:null));}
					}
					break;
				case 10 :
					// Types.g:61:9: ^( DEREF a= expr )
					{
					...
					if ( state.backtracking==1 ) {retval.type =symtab.ptrDeref((a!=null?((CymbolAST)a.start):null));}
					}
					break;
				case 11 :
					// Types.g:63:9: member
	...
	// Types.g:68:1: binaryOps returns [Type type] : ( ^( bop a= expr b= expr ) | ^( relop a= expr b= expr ) | ^( eqop a= expr b= expr ) ) ;
	public final Types.binaryOps_return binaryOps() throws RecognitionException {
		...
		try {
			// Types.g:70:2: ( ( ^( bop a= expr b= expr ) | ^( relop a= expr b= expr ) | ^( eqop a= expr b= expr ) ) )
			// Types.g:70:4: ( ^( bop a= expr b= expr ) | ^( relop a= expr b= expr ) | ^( eqop a= expr b= expr ) )
			{
			// Types.g:70:4: ( ^( bop a= expr b= expr ) | ^( relop a= expr b= expr ) | ^( eqop a= expr b= expr ) )
			int alt5=3;
			switch ( input.LA(1) ) {
			...
			switch (alt5) {
				case 1 :
					// Types.g:70:6: ^( bop a= expr b= expr )
					{
					...
					break;
				case 2 :
					// Types.g:71:5: ^( relop a= expr b= expr )
					{
					...
					break;
				case 3 :
					// Types.g:72:5: ^( eqop a= expr b= expr )
					{
	...
	// $ANTLR start "call"
	// Types.g:76:1: call returns [Type type] : ^( CALL ID ^( ELIST ( expr )* ) ) ;
	public final Types.call_return call() throws RecognitionException {
		...
		try {
			// Types.g:78:2: ( ^( CALL ID ^( ELIST ( expr )* ) ) )
			// Types.g:78:4: ^( CALL ID ^( ELIST ( expr )* ) )
			{
			...
			if ( input.LA(1)==Token.DOWN ) {
				...
				while (true) {
					...
					if ( ((LA6_0 >= ADD && LA6_0 <= ADDR)||(LA6_0 >= CALL && LA6_0 <= DEREF)||(LA6_0 >= FLOAT && LA6_0 <= INT)||LA6_0==MEMBER||(LA6_0 >= UNARY_MINUS && LA6_0 <= UNARY_NOT)||LA6_0==27||LA6_0==31||LA6_0==33||LA6_0==35||(LA6_0 >= 38 && LA6_0 <= 42)||LA6_0==50||LA6_0==55) ) {
						alt6=1;
					}
					...
					case 1 :
						...
						state._fsp--;
						if (state.failed) return retval;
						if ( state.backtracking==1 ) {args.add((expr8!=null?((CymbolAST)expr8.start):null));}
						}
						break;
	...
	// $ANTLR start "member"
	// Types.g:85:1: member returns [Type type] : ^( '.' expr ID ) ;
	public final Types.member_return member() throws RecognitionException {
		...
		try {
			// Types.g:86:2: ( ^( '.' expr ID ) )
			// Types.g:86:4: ^( '.' expr ID )
			{
	...
	public final void bop() throws RecognitionException {
		try {
			...
			// Types.g:
			{
			if ( input.LA(1)==ADD||input.LA(1)==31||input.LA(1)==33||input.LA(1)==35 ) {
				input.consume();
	...
	public final void relop() throws RecognitionException {
		try {
			...
			// Types.g:
			{
			if ( (input.LA(1) >= 38 && input.LA(1) <= 39)||(input.LA(1) >= 41 && input.LA(1) <= 42) ) {
				input.consume();
				state.errorRecovery=false;
				state.failed=false;
			}
	...
	public final void eqop() throws RecognitionException {
		try {
			...
			// Types.g:
			{
			if ( input.LA(1)==27||input.LA(1)==40 ) {
				input.consume();
				state.errorRecovery=false;
				state.failed=false;
			}
	...
	public static final BitSet FOLLOW_52_in_ifstat106 = new BitSet(new long[]{0x0000000000000004L});
	...
	public static final BitSet FOLLOW_54_in_ret177 = new BitSet(new long[]{0x0000000000000004L});
	...
	public static final BitSet FOLLOW_55_in_expr269 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_50_in_expr286 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_expr_in_binaryOps538 = new BitSet(new long[]{0x008407CA88CB8E30L});
	...
	public static final BitSet FOLLOW_expr_in_binaryOps558 = new BitSet(new long[]{0x008407CA88CB8E30L});
	...
	public static final BitSet FOLLOW_expr_in_binaryOps576 = new BitSet(new long[]{0x008407CA88CB8E30L});
	...
	public static final BitSet FOLLOW_ID_in_call611 = new BitSet(new long[]{0x0000000000001000L});
	public static final BitSet FOLLOW_ELIST_in_call614 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expr_in_call617 = new BitSet(new long[]{0x008407CA88CB8E38L});
	public static final BitSet FOLLOW_MEMBER_in_member646 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expr_in_member648 = new BitSet(new long[]{0x0000000000010000L});
