...
// $ANTLR 3.5.2 Def.g 2016-12-28 13:39:59
...
public class Def extends TreeFilter {
		...
		try {
			...
			switch (alt6) {
				case 1 :
					...
					{
					match(input,40,FOLLOW_40_in_type459); if (state.failed) return type;
	...
	public static final BitSet FOLLOW_40_in_type459 = new BitSet(new long[]{0x0000000000000004L});
