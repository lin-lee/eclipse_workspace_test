...
public class PFTMXLocator extends org.apache.axis.client.Service implements server.SayHello.PFTMX {
    ...
    private java.lang.String PFTMXPort_address = "http://open.elonghushan.com.cn/openService/pftMX_lhs.php";
    ...
    public server.SayHello.PFTMXPort_PortType getPFTMXPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            server.SayHello.PFTMXBindingStub _stub = new server.SayHello.PFTMXBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (server.SayHello.PFTMXPort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                server.SayHello.PFTMXBindingStub _stub = new server.SayHello.PFTMXBindingStub(new java.net.URL(PFTMXPort_address), this);
                _stub.setPortName(getPFTMXPortWSDDServiceName());
                return _stub;
            }
        }
