...
public class ScenicResult  implements java.io.Serializable {
    private server.SayHello.shandong.ScenicBean[] list;
    ...
    public ScenicResult(
           server.SayHello.shandong.ScenicBean[] list,
     ...
     * @return list
     */
    public server.SayHello.shandong.ScenicBean[] getList() {
        return list;
    }
     ...
     * @param list
     */
    public void setList(server.SayHello.shandong.ScenicBean[] list) {
        this.list = list;
    }
