...
public class ProductInfoBean  implements java.io.Serializable {
    private java.lang.Integer advanceDay;
    ...
    private server.SayHello.shandong.ProductType productType;

    private java.lang.String product_description;

    private java.lang.String product_name;

    private java.lang.String providers;
    ...
    private server.SayHello.shandong.StrategyProductBean[] strategyProductList;
    ...
    public ProductInfoBean(
           java.lang.Integer advanceDay,
           java.lang.Integer people_count,
           java.lang.Double price,
           java.lang.String productInfo_id,
           server.SayHello.shandong.ProductType productType,
           ...
           server.SayHello.shandong.StrategyProductBean[] strategyProductList,
    ...
    /**
     * Gets the advanceDay value for this ProductInfoBean.
     * 
     * @return advanceDay
     */
    ...
    /**
     * Sets the advanceDay value for this ProductInfoBean.
     * 
     * @param advanceDay
     */
    ...
    /**
     * Gets the productType value for this ProductInfoBean.
     * 
     * @return productType
     */
    public server.SayHello.shandong.ProductType getProductType() {
        return productType;
    }


    /**
     * Sets the productType value for this ProductInfoBean.
     * 
     * @param productType
     */
    public void setProductType(server.SayHello.shandong.ProductType productType) {
        this.productType = productType;
    }
    ...
    /**
     * Gets the providers value for this ProductInfoBean.
     * 
     * @return providers
     */
    ...
    /**
     * Sets the providers value for this ProductInfoBean.
     * 
     * @param providers
     */
    public void setProviders(java.lang.String providers) {
        this.providers = providers;
    }
     ...
     */
    public server.SayHello.shandong.StrategyProductBean[] getStrategyProductList() {
        return strategyProductList;
    }
     ...
     */
    public void setStrategyProductList(server.SayHello.shandong.StrategyProductBean[] strategyProductList) {
        this.strategyProductList = strategyProductList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.advanceDay==null && other.getAdvanceDay()==null) || 
             (this.advanceDay!=null &&
              this.advanceDay.equals(other.getAdvanceDay()))) &&
            ...
            ((this.providers==null && other.getProviders()==null) || 
             (this.providers!=null &&
              this.providers.equals(other.getProviders()))) &&
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        if (getAdvanceDay() != null) {
            _hashCode += getAdvanceDay().hashCode();
        }
        ...
        if (getProviders() != null) {
            _hashCode += getProviders().hashCode();
        }
    ...
    static {
        ...
        elemField.setFieldName("advanceDay");
        elemField.setXmlName(new javax.xml.namespace.QName("http://product.bean.xz.com", "advanceDay"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://product.bean.xz.com", "productType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://InfoEnums.xz.com", "ProductType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://product.bean.xz.com", "providers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
