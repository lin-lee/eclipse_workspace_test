...
public class BookingTicketImplServiceLocator extends org.apache.axis.client.Service implements server.SayHello.BookTicket.BookingTicketImplService {
    ...
    private java.lang.String BookingTicketImplPort_address = "http://42.202.146.13:8080/TicketWebService/BookTicket";
    ...
    public server.SayHello.BookTicket.BookingTicket getBookingTicketImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public server.SayHello.BookTicket.BookingTicket getBookingTicketImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            server.SayHello.BookTicket.BookingTicketImplServiceSoapBindingStub _stub = new server.SayHello.BookTicket.BookingTicketImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (server.SayHello.BookTicket.BookingTicket.class.isAssignableFrom(serviceEndpointInterface)) {
                server.SayHello.BookTicket.BookingTicketImplServiceSoapBindingStub _stub = new server.SayHello.BookTicket.BookingTicketImplServiceSoapBindingStub(new java.net.URL(BookingTicketImplPort_address), this);
                _stub.setPortName(getBookingTicketImplPortWSDDServiceName());
                return _stub;
            }
        }
